...
/**
 ** \file parser.h
 ** Define the gvl::lang::parser class.
 */
...
# if 201103L <= YY_CPLUSPLUS
  ...
  private:
    ...
    END = 274,                     // END
    EXIT = 275,                    // EXIT
    SUBSTRING = 276,               // SUBSTRING
    LENGTH = 277,                  // LENGTH
    POSITION = 278,                // POSITION
    CONCATENATE = 279,             // CONCATENATE
    BOOL_TRUE = 280,               // BOOL_TRUE
    BOOL_FALSE = 281,              // BOOL_FALSE
    ASSIGN = 282,                  // ASSIGN
    PLUS = 283,                    // PLUS
    MINUS = 284,                   // MINUS
    MUL = 285,                     // MUL
    ...
    struct symbol_kind
    {
      enum symbol_kind_type
      {
        ...
        S_DO = 14,                               // DO
        S_PRINT = 15,                            // PRINT
        S_READINT = 16,                          // READINT
        S_READSTR = 17,                          // READSTR
        S_BEG = 18,                              // BEG
        S_END = 19,                              // END
        S_EXIT = 20,                             // EXIT
        S_SUBSTRING = 21,                        // SUBSTRING
        S_LENGTH = 22,                           // LENGTH
        S_POSITION = 23,                         // POSITION
        S_CONCATENATE = 24,                      // CONCATENATE
        S_BOOL_TRUE = 25,                        // BOOL_TRUE
        S_BOOL_FALSE = 26,                       // BOOL_FALSE
        S_ASSIGN = 27,                           // ASSIGN
        S_PLUS = 28,                             // PLUS
        S_MINUS = 29,                            // MINUS
        S_MUL = 30,                              // MUL
        ...
        S_num_expr = 46,                         // num_expr
        S_t_num_expr = 47,                       // t_num_expr
        S_f_num_expr = 48,                       // f_num_expr
        S_str_expr = 49,                         // str_expr
        S_num_rel = 50,                          // num_rel
        S_str_rel = 51,                          // str_rel
        S_bool_expr = 52,                        // bool_expr
        S_t_bool_expr = 53,                      // t_bool_expr
        S_f_bool_expr = 54,                      // f_bool_expr
        S_simple_instr = 55,                     // simple_instr
        S_instr = 56,                            // instr
        S_assign_stat = 57,                      // assign_stat
        S_if_stat = 58,                          // if_stat
        S_while_stat = 59,                       // while_stat
        S_until_stat = 60,                       // until_stat
        S_output_stat = 61,                      // output_stat
...
switch (yykind)
    ...
    // Implementation of make_symbol for each token kind.
      ...
      static
      symbol_type
      make_NUM (std::int32_t v, location_type l)
      {
      ...
      static
      symbol_type
      make_NUM (const std::int32_t& v, const location_type& l)
      {
      ...
      static
      symbol_type
      make_READINT (location_type l)
      {
        return symbol_type (token::READINT, std::move (l));
      }
#else
      static
      symbol_type
      make_READINT (const location_type& l)
      {
        return symbol_type (token::READINT, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      symbol_type
      make_READSTR (location_type l)
      {
        return symbol_type (token::READSTR, std::move (l));
      }
#else
      static
      symbol_type
      make_READSTR (const location_type& l)
      {
        return symbol_type (token::READSTR, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      ...
      static
      symbol_type
      make_CONCATENATE (location_type l)
      {
        return symbol_type (token::CONCATENATE, std::move (l));
      }
#else
      static
      symbol_type
      make_CONCATENATE (const location_type& l)
      {
        return symbol_type (token::CONCATENATE, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      symbol_type
      make_BOOL_TRUE (location_type l)
      {
      ...
      static
      symbol_type
      make_BOOL_FALSE (location_type l)
      {
      ...
      static
      symbol_type
      make_STR_EQ (location_type l)
      {
        return symbol_type (token::STR_EQ, std::move (l));
      }
#else
      static
      symbol_type
      make_STR_EQ (const location_type& l)
      {
        return symbol_type (token::STR_EQ, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      symbol_type
      make_STR_NE (location_type l)
      {
        return symbol_type (token::STR_NE, std::move (l));
      }
#else
      static
      symbol_type
      make_STR_NE (const location_type& l)
      {
        return symbol_type (token::STR_NE, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
